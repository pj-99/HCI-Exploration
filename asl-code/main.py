...
# TODO: this can change hands
MAX_HANDS = 4                   #@param {type: "integer"}
...
def parse_opt():
    ...
    parser.add_argument('-c', '--camera-index', type=str, default=1, help='Camera index')
